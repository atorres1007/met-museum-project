...
export default function GreekAndRomanArtPage () {
//Variables
...
//Asyncronous Fetch Statements
  ...
  const getObjectIDs = async () => {
    const response = await fetch(
      "https://collectionapi.metmuseum.org/public/collection/v1/search?departmentId=13&q=a");
    ...
    return(
        <div>
            <div className="department-title">
              <h1><a href="https://www.metmuseum.org/about-the-met/collection-areas/greek-and-roman-art" target="_blank">
              Greek and Roman Art</a></h1>
            </div>

...
export default function AmericanWingPage () {
//Variables
...
//Asyncronous Fetch Statements
  ...
  const getObjectIDs = async () => {
    const response = await fetch(
      "https://collectionapi.metmuseum.org/public/collection/v1/search?departmentId=1&q=cat");
    ...
    return(
        <div>
            <div className="department-title">
              <h1><a href="https://www.metmuseum.org/about-the-met/collection-areas/the-american-wing" target="_blank">
              The American Wing</a></h1>
            </div>

...
export default function EgyptianArtPage () {
//Variables
...
//Asyncronous Fetch Statements
  ...
  const getObjectIDs = async () => {
    const response = await fetch(
      "https://collectionapi.metmuseum.org/public/collection/v1/search?departmentId=10&q=a");
    ...
    return(
        <div>
            <div className="department-title">
              <h1><a href="https://www.metmuseum.org/about-the-met/collection-areas/egyptian-art" target="_blank">
              Egyptian Art</a></h1>
            </div>

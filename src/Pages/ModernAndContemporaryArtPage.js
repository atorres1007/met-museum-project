...
export default function ModernAndContemporaryArtPage () {
//Variables
...
//Asyncronous Fetch Statements
  ...
  const getObjectIDs = async () => {
    const response = await fetch(
      "https://collectionapi.metmuseum.org/public/collection/v1/search?departmentId=21&q=a");
    ...
    return(
        <div>
            <div className="department-title">
              <h1><a href="https://www.metmuseum.org/about-the-met/collection-areas/modern-and-contemporary-art" target="_blank">
              Modern and Contemporary Art</a></h1>
            </div>

...
export default function RobertLehmanCollectionPage () {
//Variables
...
//Asyncronous Fetch Statements
  ...
  const getObjectIDs = async () => {
    const response = await fetch(
      "https://collectionapi.metmuseum.org/public/collection/v1/search?departmentId=15&q=a");
    ...
    return(
        <div>
            <div className="department-title">
              <h1><a href="https://www.metmuseum.org/about-the-met/collection-areas/the-robert-lehman-collection" target="_blank">
              The Robert Lehman Collection</a></h1>
            </div>
